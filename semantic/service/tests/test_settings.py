...
from frostlog_semantic.settings import Settings, topic_path


def test_the_short_topic_name_becomes_a_full_one() -> None:
    # Terraform passes the short name; Pub/Sub wants the path.
    assert topic_path("chanyou-frostlog", "frostlog-semantic-updated") == (
        "projects/chanyou-frostlog/topics/frostlog-semantic-updated"
    )


def test_a_full_topic_name_is_left_alone() -> None:
    full = "projects/other/topics/frostlog-semantic-updated"
