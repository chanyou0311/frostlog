...
def test_a_failure_reports_itself_to_the_channel(
    ...
    notifier = build_notifier(arrived, slack, settings)
    notifier.report_failure("events/semantic-updated", ValueError("boom"))
...
def test_a_defect_that_keeps_coming_back_is_reported_once_a_day(
    ...
    notifier.report_failure("events/semantic-updated", KeyError("other"))
    ...
    tomorrow.report_failure("events/semantic-updated", ValueError("boom"))
